...
namespace InventoryMaintenance
{
    public partial class frmInvMaint : Form
	{
		...
		private void FillItemListBox()
		{
			...
			{
				lstItems.Items.Add(x.GetDisplayText());
			}
		}
		...
		private void btnAdd_Click(object sender, EventArgs e)
		{
			...
			InvItem newItem = new frmNewItem().GetNewItem();
			if (newItem != null)
            {
				items.Add(newItem);
		...
		private void btnDelete_Click(object sender, EventArgs e)
		{
			...
			if (i != -1)
			{
				...
				DialogResult d = MessageBox.Show("Are you sure you want to delete this entry?", "Alert!", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
